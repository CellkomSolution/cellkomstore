  ...
  if (isSessionLoading || isLoading) {
    return (
      <Card className="h-full flex flex-col">
        <CardHeader>
          <CardTitle>Percakapan Chat Admin</CardTitle>
        </CardHeader>
            ...
            <TableBody>
              {conversations.length === 0 ? (
                ...
                conversations.map((conv) => (
                  ...
                  >
                    <TableCell>
                      <Link href={`/admin/chats/${conv.user_id}`} className="flex items-center gap-3">
                    ...
                    <TableCell>
                      <Link href={`/admin/chats/${conv.user_id}`} className="flex flex-col">
