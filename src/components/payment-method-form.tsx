...
const formSchema = z.object({
  ...
  is_active: z.boolean().default(true), // Removed .optional()
  order: z.coerce.number().min(0, { message: "Urutan tidak boleh negatif." }).default(0), // Removed .optional() and added default
});
