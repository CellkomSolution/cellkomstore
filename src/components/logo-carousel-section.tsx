...
// SVG Icons (moved here for self-containment as per guidelines)
...
// Masukkan semua logo ke dalam array
const allLogos = [
...
export function LogoCarouselSection() {
  return (
    <div className="space-y-8 py-12"> {/* Adjusted padding */}
      <div className="mx-auto flex w-full max-w-screen-lg flex-col items-center space-y-8">
        <div className="text-center">
          <GradientHeading variant="secondary" size="lg">
            Dipercaya oleh Brand Ternama
          </GradientHeading>
          <GradientHeading size="xl">Mitra Kami</GradientHeading> {/* Adjusted size */}
        </div>
