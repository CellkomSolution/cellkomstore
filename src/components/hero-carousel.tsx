...
interface CarouselBanner {
  productImageSrc: string; // Image for the product on the right side
  alt: string;
  logoSrc?: string; // Logo for the brand on the left side
  productName?: string;
  originalPrice?: number;
  discountedPrice?: number;
  isNew?: boolean;
  hashtag?: string;
  leftPanelBgColor?: string; // Background color for the left text panel
}
